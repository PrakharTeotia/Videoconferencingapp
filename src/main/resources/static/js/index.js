function loadAndDisplayUsers() {
  ...
  fetch('https://videoconferencingapp-1.onrender.com/api/v1/users')
      .then((response) => {
...
function handleLogout() {
  fetch('https://videoconferencingapp-1.onrender.com/api/v1/users/logout', {
      method: 'POST',
      headers: {
...
function handleNewMeeting() {
  ...
  window.open(`videoconferencingapp.html?username=${connectedUser.username}`, "_blank");
}
...
function handleJoinMeeting() {
  ...
  const url = `videoconferencingapp.html?roomID=${roomId}&username=${connectedUser.username}`;
